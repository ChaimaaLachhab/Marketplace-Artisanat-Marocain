...
export class DashComponent {
  stats = [
    { label: 'Data label', value: '6,452', change: 5.39, positive: true },
    { label: 'Data label', value: '42,502', change: 0.65, positive: false },
    { label: 'Data label', value: '56,201', change: 2.29, positive: true }
  ];
